    ...
    ui(new Ui::MainWindow)
{
    ...
    setMinimumSize(QSize(310, 390));
    //setMaximumSize(QSize(600, 420));
    ui->centralWidget->setFixedSize(QSize(420, 360));
...
//    mainLayout = new QHBoxLayout(mainWidget);
    ...
    //historyWidget->setFixedSize(230,400);
    ...
    connect(hideHistoryButton, &QPushButton::clicked, this, &MainWindow::on_hide_clicked);
    connect(clearHistoryButton, &QPushButton::clicked, this, &MainWindow::on_clear_clicked);
    connect(historyView, &QListWidget::itemClicked, this, &MainWindow::on_item_clicked);
    connect(ui->show_history, &QAction::triggered, this, &MainWindow::on_show_clicked);
    connect(ui->hide_history, &QAction::triggered, this, &MainWindow::on_hide_clicked);
    connect(ui->about, &QAction::triggered, this, &MainWindow::on_about_clicked);


    historyLayout->addWidget(hideHistoryButton);
...
//    setCentralWidget(mainWidget);
    ...
    ui->centralWidget->setMaximumWidth(300);
...
//     QString historyItem;
//     historyItem = QString::number(storedNumber, 'f', 0) + ' ' + storedOperator + ' ' + oldDis + ' ' + '=' + ' ' + displayLabel;

//     historyList.append(displayLabel);
//     historyView->addItem(displayLabel);
//     ui->statusBar->showMessage("Значение внесено", 3000);
...
void MainWindow::on_save_clicked(){
    QString value = ui->displayPanel->text();
    if(value.isEmpty()){
        ui->statusBar->showMessage("Пустое значение не внесено в историю", 5000);
        return;
    }
    historyList.append(value);
    historyView->addItem(value);
    ui->statusBar->showMessage("Значение " + value + " внесено", 5000);
}

void MainWindow::on_clear_clicked(){
    historyList.clear();
    historyView->clear();
    ui->statusBar->showMessage("История очищена", 5000);
}
